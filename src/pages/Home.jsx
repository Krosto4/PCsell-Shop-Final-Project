    ...
    if (user) {
      return (
        <Nav className="me-auto">
          ...
          <Link
            onClick={logOutUser}
            className="mx-2 p-1 rounded text-light bg-danger"
          >
            Log Out
          </Link>
        </Nav>
        ...
        <Carousel className="col-9 m-auto">
          <Carousel.Item style={{ maxHeight: "90vh" }}>
            <div className="d-flex justify-content-center">
              <img
                width={"75%"}
                src="https://images-cdn.ubuy.co.in/635f8ad9afed8b54834faff3-dell-xps-13-plus-9320-13-4.jpg"
                alt=""
              />
            </div>
            <Carousel.Caption>
          ...
          <Carousel.Item style={{ maxHeight: "90vh" }}>
            <div className="d-flex justify-content-center">
              <img
                width={"80%"}
                src="https://m.media-amazon.com/images/I/71o6nKXmjTL._AC_SL1500_.jpg"
                alt=""
              />
            </div>
            <Carousel.Caption>
          ...
          <Carousel.Item style={{ maxHeight: "90vh" }}>
            <div className="d-flex justify-content-center">
              <img
                width={"75%"}
                src="https://www.notebookcheck.net/uploads/tx_nbc2/MateBook_X_Pro_2023_8.jpg"
                alt=""
              />
            </div>
            <Carousel.Caption>
              <h3>Huawei MateBook X Pro</h3>
              <p>Sleek ultrabook with a vibrant display</p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
      </section>
